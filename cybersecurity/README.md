...
|:----|:-------------|:--------|:------|
| 🪟 **Splunk Universal Forwarder** | Windows → Splunk Indexer log ingestion | ✅ Complete | [View Lab →](/cybersecurity/Enterprise-Cybersecurity-Lab/siem/splunk-forwarder-lab/) |
| ⚙️ **Sysmon Integration** | Endpoint visibility with granular process and registry telemetry | 🧩 In Progress | [View Lab →](/cybersecurity/Enterprise-Cybersecurity-Lab/siem/sysmon-integration-lab/) |
| 🧾 **Rsyslog → Splunk** | Linux log forwarding pipeline (Ubuntu syslog server) | ✅ Complete | [View Lab →](/cybersecurity/Enterprise-Cybersecurity-Lab/siem/rsyslog-forwarding-lab/) |
