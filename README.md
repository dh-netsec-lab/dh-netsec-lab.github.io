...
**→ [Open Lab](/network-security/palo-alto-labs/palo-alto-panorama/)**

---

#### 🌉 Palo Alto Overlapping Subnets S2S VPN  
*Two Palo Alto firewalls (FW188 & FW189) configured with overlapping subnets, NAT, and validated IPsec tunnels.*  
**→ [Open Lab](/network-security/palo-alto-labs/palo-alto-overlapping-subnet-lab/)**
...
**→ [Open Lab](/cybersecurity/Enterprise-Cybersecurity-Lab/siem/suricata-lab/)**

---

#### 📊 Splunk SIEM Visibility Pipeline  
*Cross-platform telemetry from Windows, Linux, Suricata, Zeek, Palo Alto, and more.*  
**→ [Open Lab](/cybersecurity/Enterprise-Cybersecurity-Lab/siem/splunk-forwarder-lab/)**

---

#### 🧩 Active Directory & PKI Integration  
*User groups, trust relationships, certificates, and foundational identity services.*  
**→ [Open Lab](/cybersecurity/Enterprise-Cybersecurity-Lab/identity-trust/active-directory/)**
...
| Network Security       | Palo Alto and Fortinet focused labs including Panorama, VPNs, and segmentation               | **[Open Network Security →](/network-security/palo-alto-labs/)** |
